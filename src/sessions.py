...
class SessionsGenerator:
    def __init__(
        ...
        self.average_battery_starting_capacity = average_battery_starting_capacity
    ...
    def synthetic_user_data(self, distinct_date_list, **kwargs) -> pd.DataFrame:
        ...
        user_df["initial_charge"] = user_df.apply(
            lambda _: random.uniform(self.average_battery_starting_capacity, 0.6), axis=1
        )
        ...
        user_df["MWh_fraction"] = user_df["power_output_rate"] / 12 / 1000
